...
st.info("This app under development, you can only explore and edit the null or missing values")
...
st.write("Get a quick overview of your dataset — view its structure, columns, summary statistics, and missing values to understand your data at a glance.")
st.divider()
